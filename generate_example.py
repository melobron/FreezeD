...
if __name__ == '__main__':
    ...
    parser.add_argument('--path', type=str, default='./pre-trained/stylegan-256px-new.model', help='path to checkpoint file')
    ...
    utils.save_image(img, './results/sample.png', nrow=args.n_col, normalize=True, range=(-1, 1))

    # for j in range(4):
    #     img = style_mixing(generator, step, mean_style, args.n_col, args.n_row, device)
    #     utils.save_image(img, f'./results/sample_mixing_{j}.png', nrow=args.n_col + 1, normalize=True, range=(-1, 1))
